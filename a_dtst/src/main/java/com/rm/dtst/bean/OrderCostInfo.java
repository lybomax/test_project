...
/**
 * @deprecated:订单融资费用信息表
 * 创建日期:2019-07-22 09:37:25
 */
@Table("order_cost_info")
public class OrderCostInfo{
   ...
   **/
   ...
   /**
      ...
      *是否必填:false 
   **/
   private java.util.Date costStart;
   /**
      *收费结束日 
      *数据类型：date 
      *是否必填:false 
   **/
   private java.util.Date costEnd;
   /**
      *建立时间 
      *数据类型：datetime(6) 
      *是否必填:true 
  ...
  //get和set方法
    ...
    */
   public java.util.Date getCostStart(){
      return costStart;
   }
    ...
    *@param costStart
    */
   public void setCostStart(java.util.Date costStart){
    ...
    *@return java.util.Date
    */
   public java.util.Date getCostEnd(){
      return costEnd;
   }
    ...
    *@param costEnd
    */
   public void setCostEnd(java.util.Date costEnd){
